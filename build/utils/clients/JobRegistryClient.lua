...
function JobRegistryClient.prototype.cancel(self, id)
    return self:call(JobRegistryCommand.CANCEL, {id = id}).ok
end
function JobRegistryClient.prototype.retry(self, id)
    return self:call(JobRegistryCommand.RETRY, {id = id}).ok
end
...
function JobRegistryClient.prototype.jobFailed(self, id, ____error)
    return self:call(JobRegistryCommand.JOB_FAILED, {id = id, error = ____error})
end

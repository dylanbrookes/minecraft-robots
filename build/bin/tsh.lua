...
local TurtleServiceCommands = ____TurtleService.TurtleServiceCommands
    ...
    EventLoop:on(
        ...
        function(____, char)
            repeat
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.forward, 1, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.back, 1, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.turnLeft, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.turnRight, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.up, 1, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.down, 1, false)
                    end
                    break
                end
                ...
                if ____cond7 then
                    do
                        sendCmd(nil, TurtleServiceCommands.dig, false)
                    end
                    break
                end
                do
